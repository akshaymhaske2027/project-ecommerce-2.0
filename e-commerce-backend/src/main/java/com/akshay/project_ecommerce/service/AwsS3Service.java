package com.akshay.project_ecommerce.service;
...
public class AwsS3Service {
    ...
    private final String bucketName = "akshay-ecommerce";
    ...
    public String saveImageToS3(MultipartFile photo){
        try {
            ...
            //https://akshay-ecommerce.s3.eu-north-1.amazonaws.com/shoe1.jpg
